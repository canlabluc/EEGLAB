...
function subjectArray = cl_allocateSubj(analysisType, numSubjects, numChannels, sampleFreq, C3trodes, O1trodes)
...
elseif strcmp(analysisType, 'cl_alphatheta')
    if ~exist('C3trodes', 'var') || ~exist('O1trodes', 'var')
        error('Please specify both the C3 and O1 electrodes');
    end
    subjectArray(:) = struct('SubjectID', 'SXXX',...
