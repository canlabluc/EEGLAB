...
for i = 1:numel(subj)
    ...
    table{i+1,6}  = subj{1,i}.ratio_meanAlphaTheta;
    table{i+1,7}  = subj{1,i}.ratio_meanAlphaThetaFixed;
    % Powers for calculated frequency bands
    table{i+1,8}  = subj{1,i}.mean_DeltaPower;
    table{i+1,9}  = subj{1,i}.mean_thetaPower;
    table{i+1,10} = subj{1,i}.mean_alphaPower;
    table{i+1,11} = subj{1,i}.mean_alpha1Power;
    table{i+1,12} = subj{1,i}.mean_alpha2Power;
    table{i+1,13} = subj{1,i}.mean_alpha3Power;
    % Powers for fixed frequency bands
    table{i+1,14} = subj{1,i}.mean_fdeltaPower;
    table{i+1,15} = subj{1,i}.mean_fthetaPower;
    table{i+1,16} = subj{1,i}.mean_falphaPower;
    table{i+1,17} = subj{1,i}.mean_fbetaPower;
    table{i+1,18} = subj{1,i}.mean_fgammaPower;
    table{i+1,19} = subj{1,i}.mean_falpha1Power;
    table{i+1,20} = subj{1,i}.mean_falpha2Power;
    table{i+1,21} = subj{1,i}.mean_falpha3Power;
end
index{100,100} = [];
...
for i = 1:numel(subj)
    ...
    index{i+1,12} = subj{i}.Gamma_ceiling;
end
